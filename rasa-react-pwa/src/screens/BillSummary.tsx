...
export default function BillSummary() {
  ...
  return (
    <div style={s('display:flex;flex-direction:column;min-height:100%')}>
      <StickyHeader title={vendor.name} onBack={() => go('billoffers')} right={scanBtn} />
      ...
      <div style={s('padding:18px 18px 0')}>
        ...
        <div style={s('display:flex;align-items:center;gap:12px;background:#fff;border:1px solid #ECE6DB;border-radius:16px;padding:13px 14px;margin-bottom:10px')}>
        ...
        <button
          onClick={goPayMethod}
          style={s('width:100%;display:flex;align-items:center;gap:12px;background:#fff;border:1px solid #ECE6DB;border-radius:16px;padding:13px 14px;cursor:pointer;text-align:left')}
        >
          ...
          <div style={s('flex:1;min-width:0')}>
            <div style={s("font:700 12.5px var(--display,'Space Grotesk');color:#3B2630")}>Pay using UPI</div>
            <div style={s("font:500 11px 'Inter';color:#9A93A6;margin-top:2px")}>Google Pay, PhonePe, Paytm &amp; more</div>
          </div>
